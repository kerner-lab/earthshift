...
ax.set_title('ID vs OOD Performance (Head Finetuning)', fontsize=16, fontweight='bold')
...
plt.tight_layout()
plt.savefig('{}/id_vs_ood_performance_head_updated.png'.format(root_dir), dpi=300, bbox_inches='tight')
print("Head finetuning ID vs OOD plot saved")